...
from medmnist import BloodMNIST # Changed for BloodMNIST
...
def run_quantum_bloodmnist_classification():
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    # Updated print statement for BloodMNIST
    print(f"Using device: {device} for quantum BloodMNIST classification test")
    ...
    output_dim_test = num_classes # 8 classes
    n_qubits_test = 8 
    q_depth_test = 1  
    ...
    print(f"Quantum Model Config for BloodMNIST: {config}\n")
    ...
    try:
        ...
        raise
    print(f"Quantum RWKVModel for BloodMNIST instantiated successfully.\n")
    ...
    print(f"Starting quantum training for BloodMNIST classification...")
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % (print_every * 5) == 0 or epoch == num_epochs -1 :
            ...
            plt.title(f'Confusion Matrix - Epoch {epoch+1} (Quantum BloodMNIST)')
    ...
    print(f"Quantum BloodMNIST training finished.\n")
    ...
    data_row = [
        ...
        experiment_id, 'Quantum', f'BloodMNIST_8x8', 
    ...
    if all_epoch_train_losses:
        ...
        plt.xlabel('Epoch')
        plt.ylabel('Loss')
        plt.title('Training Loss Over Epochs (Quantum BloodMNIST)')
        plt.legend()
        plt.grid(True)
    ...
    if all_epoch_test_accuracies:
        ...
        plt.xlabel('Epoch')
        plt.ylabel('Accuracy (%)')
        plt.title('Test Accuracy Over Epochs (Quantum BloodMNIST)')
        plt.legend()
        plt.grid(True)
    ...
    print(f"\n=== Finished Quantum BloodMNIST Classification Test ===\n")

if __name__ == '__main__':
    run_quantum_bloodmnist_classification() 