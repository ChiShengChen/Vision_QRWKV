...
# MedMNIST import
from medmnist import RetinaMNIST # Changed for RetinaMNIST
...
def run_quantum_retinamnist_classification():
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    # Updated print statement for RetinaMNIST
    print(f"Using device: {device} for quantum RetinaMNIST classification test")
    ...
    print(f"Quantum Model Config for RetinaMNIST: {config}\n")
    ...
    print(f"Quantum RWKVModel for RetinaMNIST instantiated successfully.\n")
    ...
    # Updated print statement
    print(f"Starting quantum training for RetinaMNIST classification...")
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % (print_every * 5) == 0 or epoch == num_epochs -1 :
            ...
            # Updated plot title
            plt.title(f'Confusion Matrix - Epoch {epoch+1} (Quantum RetinaMNIST)')
    ...
    # Updated print statement
    print(f"Quantum RetinaMNIST training finished.\n")
    ...
    data_row = [
        ...
        experiment_id, 'Quantum', f'RetinaMNIST_8x8', # Updated Task name
    ...
    if all_epoch_train_losses:
        ...
        plt.ylabel('Loss')
        # Updated plot title
        plt.title('Training Loss Over Epochs (Quantum RetinaMNIST)')
        plt.legend()
        plt.grid(True)
    ...
    if all_epoch_test_accuracies:
        ...
        plt.ylabel('Accuracy (%)')
        # Updated plot title
        plt.title('Test Accuracy Over Epochs (Quantum RetinaMNIST)')
        plt.legend()
        plt.grid(True)
    ...
    print(f"\n=== Finished Quantum RetinaMNIST Classification Test ===\n")

if __name__ == '__main__':
    # Updated function call
    run_quantum_retinamnist_classification() 